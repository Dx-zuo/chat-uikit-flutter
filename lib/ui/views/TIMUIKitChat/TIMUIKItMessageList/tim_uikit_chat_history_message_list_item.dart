...
class _TIMUIKItHistoryMessageListItemState
  ...
  _onOpenToolTip(
    ...
    final tapDetails =
        (isWideScreen || isLongMessage) ? (details ?? _tapDetails) : details;
  ...
  initTools(
    ...
    if (context != null) {
      ...
      if (details != null && box != null) {
        ...
        hasArrow = isWideScreen ? false : true;
        arrowTipDistance = 0;
        arrowBaseWidth = 0;
        arrowLength = 0;
    ...
    tooltip = SuperTooltip(
      ...
      hasShadow: isWideScreen ? false : true,
      borderWidth: 1.0,
  ...
  Widget renderHoverTipAndReadStatus(TUIChatSeparateViewModel model,
    ...
    return Column(
      ...
      children: [
        if (isWideScreen && isShowWideToolTip)
          Container(
            decoration: BoxDecoration(
