...
class TIMUIKitSearchInputState extends TIMUIKitState<TIMUIKitSearchInput> {
  ...
  Widget tuiBuild(BuildContext context, TUIKitBuildValue value) {
    ...
    return Container(
      // height: 64,
      padding: EdgeInsets.fromLTRB(16, isWideScreen ? 16 : 8, 16, 16),
      margin: isWideScreen ? const EdgeInsets.only(bottom: 2) : null,
      ...
      child: Row(
        ...
        children: [
          Expanded(
            ...
            constraints: BoxConstraints(maxHeight: isWideScreen ? 30 : 36),
            child: TextField(
              ...
              style: isWideScreen ? const TextStyle(
                fontSize: 12
              ) : null,
              decoration: InputDecoration(
                ...
                fillColor: isWideScreen ? hexToColor("f3f3f4") : Colors.white,
                filled: true,
                isDense: true,
                hintText: TIM_t("搜索"),
