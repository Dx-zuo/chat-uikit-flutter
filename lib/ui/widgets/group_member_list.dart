...
class _GroupProfileMemberListState
  ...
  Widget _buildListItem(
    ...
    final isWideScreen =
        TUIKitScreenUtils.getFormFactor() == ScreenType.Wide;
    final isGroupMember =
  ...
  Widget tuiBuild(BuildContext context, TUIKitBuildValue value) {
    ...
    return Container(
      color: isWideScreen ? null : theme.weakBackgroundColor,
      child: SafeArea(
          child: Column(
        children: [
          ...
          Expanded(
            ...
            child: (showList.isEmpty)
                ...
                : Container(
              padding: isWideScreen ? const EdgeInsets.symmetric( horizontal: 16) : null,
