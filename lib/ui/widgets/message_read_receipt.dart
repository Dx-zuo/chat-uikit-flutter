        ...
        child: Row(
          children: [
            Container(
              ...
              margin: EdgeInsets.only(right: 12, bottom: isWideScreen ? 6 : 0),
              child: Avatar(faceUrl: faceUrl, showName: showName),
            ),
            Expanded(
                child: Container(
              alignment: Alignment.centerLeft,
              padding: EdgeInsets.only(top: 10, bottom: isWideScreen ? 14 : 19, right: 28),
              ...
              children: <Widget>[
                Expanded(
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      height: isWideScreen ? 40 : 50.0,
                      alignment: Alignment.bottomCenter,
                      padding: EdgeInsets.only(bottom: isWideScreen ? 8 : 12),
                      decoration: BoxDecoration(
                          color: Colors.white,
                          border: Border(
                              bottom: BorderSide(
