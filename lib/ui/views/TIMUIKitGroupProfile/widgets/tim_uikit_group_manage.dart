              ...
              children: [
                Container(
                  padding: EdgeInsets.only(
                      ...
                      bottom: isWideScreen ? 0 : 12,
                      right: isWideScreen ? 0 : 12),
                  decoration: BoxDecoration(
                      color: Colors.white,
                      border: isWideScreen
                          ? null
                ...
                if (isWideScreen && isAllowMuteMember)
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text(TIM_t("禁言"),
...
Widget _buildListItem(BuildContext context, V2TimGroupMemberFullInfo memberInfo,
    ...
    return Container(
      ...
      child: Column(children: [
        ListTile(
          ...
          leading: SizedBox(
            width: isWideScreen ? 30 : 36,
            height: isWideScreen ? 30 : 36,
            child: Avatar(
          ...
          title: Row(
            children: [
              Text(_getShowName(memberInfo),
                  style: TextStyle(fontSize: isWideScreen ? 14 : 16)),
            ],
          ),
          onTap: () {},
        ),
  ...
  return TUIKitScreenUtils.getDeviceWidget(
      wideWidget: nameItem(),
      defaultWidget:
      Slidable(endActionPane: endActionPane, child: nameItem()));
}
          ...
          return SingleChildScrollView(
            ...
            children: [
              ...
              ...ownerList
                  .map(
                    (e) => Container(
                      padding: isWideScreen ? const EdgeInsets.only(left: 16) : null,
