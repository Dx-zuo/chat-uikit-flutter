    ...
    return Row(
      ...
      children: [
        if (widget.isMultiSelect)
          Container(
            padding: EdgeInsets.only(left: isWideScreen ? 8 : 16.0, top: isWideScreen ? 10 : 0),
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  ...
                  padding: EdgeInsets.only(top: 10, bottom: isWideScreen ? 12 : 19),
                  decoration: isWideScreen ? null : const BoxDecoration(
                      border:
                  ...
                  child: Text(
                    ...
                    style:
                    TextStyle(color: const Color(0xFF111111), fontSize: isWideScreen ? 16 : 18),
                  ),
                ))
              ],
            ),
      ...
      builder: (context, w) {
        ...
        return AZListViewContainer(
          ...
          susItemBuilder: (context, index) {
            return isWideScreen ? Container() : Container(
              height: 40,
